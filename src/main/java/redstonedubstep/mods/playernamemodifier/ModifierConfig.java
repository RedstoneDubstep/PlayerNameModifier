		...
		Config(ModConfigSpec.Builder builder) {
			playerNameModifiers = builder
					.comment(" --- PlayerNameModifier Config File --- ",
							...
							"These modifier patterns can be a simple string literal (encased in escaped quotes, like \\\"this\\\"), but also support SNBT component definitions (if you happen to know what that means). An example of that would be {text:'This %player',color:'yellow'}.",
