	...
	public static class Config {
		...
		Config(ModConfigSpec.Builder builder) {
			builder.comment(" --- PlayerNameModifier Config File --- ",
					...
					"Both of these entries are parsed as a text component. They can be a simple string literal (surrounded by an extra set of quotes; see below for an example), or a proper JSON-defined component.",
					"Please note that selector component types are not supported due to recursion issues.",
					"- The \"displayNameStyle\" entry is parsed as a style object. It can be treated like an JSON text component where the \"text\" property is ignored. See below for examples.",
					"After applying the prefix and suffix to the player name, this style will be applied to the whole resulting component.",
					"",
					"For formatting a player's tab list name, separate modifiers exist in the form of \"tabListPrefix\", \"tabListSuffix\", and \"tabListStyle\". They work analoguous to the modifiers described above.",
					"",
					...
					"[[playerNameModifiers]]",
					"	tags = [\"badperson\"]",
					"	displayNamePrefix = '[\"\", {\"text\": \"Do not \", \"color\":\"dark_red\", \"underlined\":true, \"hoverEvent\":{\"action\": \"show_text\", \"value\": \"I really mean it!\"}}, {\"text\": \"listen to \", \"color\":\"red\"}]'",
